...
1. `git clone https://github.com/blabla/blaablaa.git`
2. `cd blaablaa`
3. `npm install`
4. Follow the steps for your preferred device/simulator (iOS only)
...
<img src="https://i.imgur.com/yKrOzRd.gif" width="800">
